<div class="page-title mb-3">Asistencia</div>
<hr>
<?php 
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-end">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <label for="class_id" class="form-label">Clases</label>
                    ...
                    <div class="container-fluid">
                        <fieldset>
                            ...
                            <div class="ps-4">
                                ...
                                <div><span class="text-body-emphasis fw-bold">L</span> <span class="ms-1">= Tarde</span></div>
                                <div><span class="text-danger fw-bold">A</span> <span class="ms-1">= Ausencia</span></div>
                                <div><span class="text-primary fw-bold">H</span> <span class="ms-1">= Vacaciones</span></div>
                            </div>
                        </fieldset>
                    </div>
                </div>
