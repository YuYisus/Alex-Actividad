<div class="page-title mb-3">Manejo de Asistencia</div>
<hr>
<?php 
                            ...
                            <table id="attendance-tbl" class="table table-bordered">
                                ...
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th class="text-center bg-transparent text-light">Presentadp</th>
                                        <th class="text-center bg-transparent text-light">Fecha </th>
                                        <th class="text-center bg-transparent text-light">Falta</th>
                                        <th class="text-center bg-transparent text-light">Vacaciones</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
